...
export const Shopping = () => {
    return (
        <Section id="shopping">
            <div className="grid grid-cols-1 lg:grid-cols-12 space-x-8">
                <div className="text-black dark:text-white max-lg:hidden lg:col-span-3 space-y-2">
                ...
                <div className="space-y-16 md:flex justify-end lg:col-span-9 xl:gap-x-16">
                    <div className="relative mx-auto max-w-md md:min-w-sm  xl:w-full min-h-50 py-7 px-5 font-bold text-lg text-black dark:text-white rounded-md bg-linear-to-b from-[#A4FEB1] to-background">
                        <h3 className=""><span className="border-t-3 border-black dark:border-white">Concept</span> Yellow</h3>
                        <div className="absolute flex items-center justify-center top-4 right-4 size-8 rounded-full bg-black text-white dark:bg-white dark:text-black">
                            <ArrowUpRight />
                        </div>
                    ...
                    <div className="p-6 space-y-4" >
                        <div className="max-w-sm mx-auto px-8 flex items-center gap-x-4">
                            ...
                            <h3 className="text-black dark:text-white">Explore Our New Cars</h3>
                        </div>
